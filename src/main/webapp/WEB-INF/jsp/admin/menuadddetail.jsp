...
<div class="content">
    <div class="tap-wrap">
        <ul class="tap">
            ...
            <!-- 일본어 / 베트남어를 지원할 경우 주석해제하고 사용하세요. -->
<%--            <li class="tab_li"><a href="#n" class="langTabBtn" data-id="Jpn">일본어</a></li>--%>
<%--            <li class="tab_li"><a href="#n" class="langTabBtn" data-id="Vt">베트남어</a></li>--%>
        </ul>
    </div>
...
<%--                    <div>--%>
<%--                        <label class="radio-wrap"><input class="radio-btn" type="radio" name="seoUseYn" id="seoUseYn01" value="Y"><span class="radio-label">사용</span></label>--%>
<%--                        <label class="radio-wrap"><input class="radio-btn" type="radio" name="seoUseYn" id="seoUseYn02" value="N" checked="checked"><span class="radio-label">사용안함</span></label>--%>
<%--                    </div>--%>
<%--                </div>--%>
...
<%--                </div>--%>
                ...
                <div class="input-wrap">
                    ...
                    <input class="flex-1" type="text" name="parent_name" id="parent_name" value="${parentInfo.menuName}" readonly style="background-color:#f3f3f3;"/>
                </div>

                <div class="input-wrap">
                    <label class="label" for="urlname">URL명</label>
                    <input class="flex-1" type="text" name="urlname" id="urlname" value=""/>
                    <br>
                ...
                <div class="input-wrap">
                    ...
                    <input class="flex-1" type="text" name="menu_name" id="menu_name" value=""/>
                </div>
...
<!--                         <textarea name="editorVisualTxt" id="editorVisualTxt" rows="20" cols="10" placeholder="비주얼 영역 HTML코드를 입력해주세요." style="width: 90%"></textarea> -->
<!--                     </div> -->
<!--                 </div> -->
                ...
                <div class="panel langPanel" id="visualEng">
                    <div class="input-wrap">
                        ...
                        <textarea name="editorVisualTxt2" id="editorVisualTxt2" rows="20" cols="10" placeholder="비주얼 영역 HTML코드를 입력해주세요." style="width: 90%"></textarea>
                    </div>
                </div>
                <div class="panel langPanel" id="Ko">
                    <div class="input-wrap type_content" >
                        <label class="label" for="editorTxt">한글컨텐츠</label>
                        <textarea name="editorTxt" id="editorTxt" rows="20" cols="10" placeholder="내용을 입력해주세요" style="width: 90%"></textarea>
                    </div>
                </div>
                <div class="panel langPanel" id="Eng">
                    <div class="input-wrap">
                        <label class="label" for="menu_name_2">영어메뉴명</label>
                        <input class="flex-1" type="text" name="menu_name_2" id="menu_name_2" value=""/>
                    </div>
                    <div class="input-wrap type_content" >
                        <label class="label" for="editorTxt2">영어컨텐츠</label>
                        <textarea name="editorTxt2" id="editorTxt2" rows="20" cols="10" placeholder="내용을 입력해주세요" style="width: 90%"></textarea>
                    </div>
                </div>
            ...
            <div class="btn-box mt-30 txt-center">
                ...
                <button class="btn form-btn bg-black" type="button" onclick="javascript:history.back();">닫기</button>
            </div>
